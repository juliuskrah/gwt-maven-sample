 ...
 * details.
 */
public class GwtTestJasperGWT extends GWTTestCase {

	/**
	 * Must refer to a valid module that sources this class.
	 */
	public String getModuleName() {
		return "com.jipasoft.sample.JasperGWTJUnit";
	}
	...
	public void testGreetingService() {
		...
		target.setServiceEntryPoint(GWT.getModuleBaseURL() + "JasperGWT/greet");
		...
		userService.findAll(new AsyncCallback<List<User>>() {
			...
			public void onSuccess(List<User> result) {
				...
				assertTrue(result.contains("julius"));
