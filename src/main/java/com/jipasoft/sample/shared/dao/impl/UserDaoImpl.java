package com.jipasoft.sample.shared.dao.impl;
...
public class UserDaoImpl implements UserDao {
	...
	@Autowired
	public void setNamedParameterJdbcTemplate(final NamedParameterJdbcTemplate namedParameterJdbcTemplate) throws DataAccessException {
	...
	public List<User> findAll() {
		...
		final List<User> result = namedParameterJdbcTemplate.query(sql, new UserMapper());
	...
	public void save(final User user) {
		...
		final String sql = "INSERT INTO USERS(NAME, EMAIL, ADDRESS, PASSWORD, NEWSLETTER, FRAMEWORK, SEX, NUMBER, COUNTRY, SKILL) "
	...
	public void update(final User user) {
		...
		final String sql = "UPDATE USERS SET NAME=:name, EMAIL=:email, ADDRESS=:address, "
	...
	private SqlParameterSource getSqlParameterByModel(final User user) {
	...
	private static List<String> convertDelimitedStringToList(final String delimitedString) {
	...
	private String convertListToDelimitedString(final List<String> list) {
