...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "JasperGWT" because\n';
  ...
  $wnd.__gwt_activeModules['JasperGWT'] = {
    'moduleName' : 'JasperGWT',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/JasperGWT.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['JasperGWT'].superdevmode = true;

  var expectedSuffix = '/JasperGWT.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + JasperGWT + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:JasperGWT';
  var devModeSessionKey = '__gwtDevModeSession:JasperGWT';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/JasperGWT/JasperGWT.nocache.js';
  ...
  $wnd.__gwt_activeModules['JasperGWT'].canRedirect = true;
  $wnd.__gwt_activeModules['JasperGWT'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/JasperGWT?user.agent=' + ua + '&_callback=' + callback;
